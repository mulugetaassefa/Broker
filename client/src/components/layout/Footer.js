        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold">Ethiopian Broker</span>
            </div>
            <p className="text-gray-300 mb-4 max-w-md">
              Your trusted platform for buying, selling, leasing, and renting properties in Ethiopia. 
              Connect with reliable brokers and find your perfect property.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li className="text-gray-300">Lease Property</li>
